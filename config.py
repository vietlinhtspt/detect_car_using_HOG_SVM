# root directory that contain all vehicle images
root_data_vehicle = './data/vehicles'

# root directory that contain all NON-vehicle images
root_data_non_vehicle = './data/non-vehicles'
